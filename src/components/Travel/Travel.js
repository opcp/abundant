    ...
    <>
      ...
      <Container className="travel_body">
        <Row className="travel_row">
          ...
          <Col xs={7} className="travel_input">
            <span>
              ...
              all over the world. In fact the volcano is one of the most active
              in Iceland, erupting frequently ever since the last glacial
              period. The Eyjafjallajökull volcano is completely covered by an
              ice cap that covers an area of over 100 square kilometres. The
              volcano‘s activity level is listed as moderate but no activity has
              been detected since the 2010 eruption..
            </span>
        ...
        <Row className="travel_row">
          ...
          <Col xs={7} className="travel_input">
            <span>
              The Sóley Spa at the Icelandair Hotel Natura is a favourite among
              the locals for a quick, relaxing soak and perhaps a glass of
              bubbly with some friends if the occasion warrants. The spa itself
              consists of a hot tub, a floating pool, a steam room and a sauna.
            </span>
            <a className="submit" href="#">
